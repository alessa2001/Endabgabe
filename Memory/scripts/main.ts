...
let ak:HTMLDivElement = <HTMLDivElement>e.target;
...
function uberprufenf():void{
    if(uberprufen.length>1 ){
        if(uberprufen[0].target.title == uberprufen[1].target.title && uberprufen[0].target.id != uberprufen[1].target.id ){ 
                ...
                let mk1:HTMLDivElement = <HTMLDivElement>uberprufen[0].target;
                mk1.classList.add('entfernen');
                let mk2:HTMLDivElement = <HTMLDivElement>uberprufen[1].target;
